 ...
 */
export type SuspenseQueriesOptions<T extends Array<any>, TResult extends Array<any> = [], TDepth extends ReadonlyArray<number> = []> = TDepth["length"] extends MAXIMUM_DEPTH
 ...
 */
export type SuspenseQueriesResults<T extends Array<any>, TResult extends Array<any> = [], TDepth extends ReadonlyArray<number> = []> = TDepth["length"] extends MAXIMUM_DEPTH
 ...
 */
export function useSuspenseQueries<T extends any[]>({ queries, context }: { queries: readonly [...SuspenseQueriesOptions<T>]; context?: UseQueryOptions["context"] }): SuspenseQueriesResults<T> {
  return useQueries({
